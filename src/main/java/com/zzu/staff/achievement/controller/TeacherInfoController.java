...
//        UserGrade userGrad = new UserGrade();
//        userGrad.setYear(YEAR);
//        userGrad.setUId(s);
//        userGrad.setStatus(0);
...
//                nTalent.getTalentGrade(),sumPass,sumPro,sumPrize,sumPatent,sumResult,sum,indexSum,0f,0f,0f,false,1);
